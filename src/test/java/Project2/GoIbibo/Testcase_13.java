//TC-13-Check if the user is able to apply for coupon code while ordering the product
...
public class Testcase_13 extends Launch_Quit {
	...
	public void ValidateApplyCoupon_13() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		a5.PassValues_promoCodeTf();
		Reporter.log("Passing values in promo Code Tf is Done");
		
		a5.checkInvlidPromoCodeTextCheck();// assertion
