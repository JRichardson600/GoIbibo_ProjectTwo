//TC-10-Validate the flight information,Fare deatils,Baggage Rules and cancellation rules link has the deatils in the seacrh result page
...
public class Testcase_10 extends Launch_Quit {
	...
	public void ValidateFlightInfo_10() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		// assertion
		a6.CheckFlightInfo();// FlightInfo
		a6.Checkfaredetail();// faredetail
		a6.CheckBagagdetails();// Bagagdetails
		a6.CheckcancellationText();// cancellationText
